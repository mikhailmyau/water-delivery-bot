...
def upgrade() -> None:
    ...
    sa.Column('price_vsm_per_liter', sa.Integer(), nullable=False),
    ...
    sa.Column('water_type', sa.Enum('SLM', 'SRM', 'VSM', 'GAZ', name='watertype', native_enum=False, length=8), nullable=False),
